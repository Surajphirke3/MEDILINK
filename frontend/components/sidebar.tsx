...
export function SidebarDemo() {
  ...
  return (
    <div
      className={cn(
        "mx-auto flex w-full h-[675px]  flex-1 flex-col overflow-hidden rounded-md border-4 border-green-900 bg-gray-100 md:flex-row dark:border-neutral-700 dark:bg-neutral-800",
  ...
  return (
    ...
    >
      <motion.span
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="text-2xl  text-[#94f27f] dark:text-white"
      >
        Medilink
      </motion.span>
    </a>
