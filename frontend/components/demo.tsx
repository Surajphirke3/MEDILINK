...
const MegaMenuDemo = () => {
  ...
  return (
    <div className="relative flex h-[80px] w-full items-start  justify-center bg-blue-400 p-6">
      <MegaMenu items={NAV_ITEMS} />
        <div className="absolute right-6 top-1/2 -translate-y-1/2">
           <Link href="/login">
        <button className="rounded-md px-4 py-2 border text-white hover:bg-black/30">
          Sign In
        </button>
      </Link>

      <Link href="/signup">
        <button className="ml-2 rounded-md px-4 py-2 border text-white hover:bg-black/30">
          Sign Up
        </button>
      </Link>
